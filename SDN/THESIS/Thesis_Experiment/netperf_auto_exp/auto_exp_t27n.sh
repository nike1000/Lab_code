...
Result_Dir="/home/kshuang/Thesis_data/netperf_1G/tree2-7n/"
...
for count in `seq 1 $repeat` ;do
    ...
    Result_iperf="tree2-7n_$count"
    Result_CSV="csv_tree2-7n_$count"
    ...
    tmux send-keys "ryu-manager /home/kshuang/Lab_code/SDN/THESIS/RYU_example/simple_switch_13.py" C-m
