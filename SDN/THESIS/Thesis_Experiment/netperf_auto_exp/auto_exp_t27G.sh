...
Result_Dir="/home/kshuang/Thesis_data/netperf_1G/tree2-7G/"
...
for count in `seq 1 $repeat` ;do
    ...
    Result_iperf="tree2-7_G$count"
    Result_CSV="csv_tree2-7_G$count"
    ...
    tmux send-keys "ryu-manager --observe-links /usr/local/lib/python2.7/dist-packages/ryu/app/gui_topology/gui_topology.py /home/kshuang/Lab_code/SDN/THESIS/RYU_example/simple_switch_13.py /home/kshuang/Lab_code/SDN/THESIS/RYU_APP_mix.py" C-m
    ...
    sleep 1
    tmux send-keys "sudo /home/kshuang/Lab_code/SDN/THESIS/topo/Topo_Generator.py /home/kshuang/Lab_code/SDN/THESIS/topo/Thesis_exp/tree2-7.txt" C-m
    sleep 35
