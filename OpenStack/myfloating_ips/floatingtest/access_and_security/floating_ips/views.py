...
from openstack_dashboard.dashboards.floatingtest.access_and_security.\
    floating_ips import forms as floatingtest_forms
from openstack_dashboard.dashboards.floatingtest.access_and_security.\
    floating_ips import workflows as floatingtest_workflows


class AssociateView(workflows.WorkflowView):
    workflow_class = floatingtest_workflows.IPAssociationWorkflow


class AllocateView(forms.ModalFormView):
    form_class = floatingtest_forms.FloatingIpAllocate
    form_id = "associate_floating_ip_form"
    modal_header = _("Allocate Floating IP")
    template_name = 'floatingtest/access_and_security/floating_ips/allocate.html'
    submit_label = _("Allocate IP")
    submit_url = reverse_lazy(
        "horizon:floatingtest:access_and_security:floating_ips:allocate")
